 ...
 */
function cpfIsValid(cpf: string, errorMsg: (string|null)[] = defaultErrorMsg): {
	isValid: boolean;
  ...
  try {
    ...
    for (let repetidor: number = 0; repetidor < 11; repetidor += 1) { // Executa os códigos 11 vezes em sequência.
